...
def make_video(audio_path, bg_path, script):
    try:
        ...
        wm1 = TextClip(text="(c) Mewonen", font_size=35, color='white', stroke_color='black', stroke_width=1)
        wm1 = wm1.with_opacity(0.5).with_position(('center', 0.88), relative=True).with_duration(dur)
        
        wm2 = TextClip(text="mewonen.com", font_size=28, color='white', stroke_color='black', stroke_width=1)
